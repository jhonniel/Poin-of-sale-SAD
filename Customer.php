      ...
      <div class="inputs">
        ...
        <form method="POST" action="Process.php">
          <p class="label-txt">First Name</p>
            <input type="text" name='cname1' onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"class="input" required>
          <br><br>
          <p class="label-txt">Last Name</p>
            <input type="text" name='lname' onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"class="input" required>
          <br><br>
          ...
          while ( $row = $result -> fetch_assoc()) {
            ...
            <tbody>
              <tr>
                ...
                <td><a  href='CustomerEdit.php?edit=<?php echo $row['id']; ?>'class="btn btn-primary a-btn-slide-text" >
                    <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                    <span>Edit</span></a></td> 

                <td><a href="Process.php?del2=<?php echo $row['id']; ?> "class="btn btn-primary a-btn-slide-text"  style="background-color: #e8171f; border:none;">
