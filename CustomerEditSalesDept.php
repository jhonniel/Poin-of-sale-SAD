...
<body>
  ...
  <div class="bodyform">
    ...
    <div class="forsearch">
      <form action="SearchCustomerSalesDept.php" method="POST">
    ...
    <div class="inputs">
       <h2 style="text-align: center; margin-top: -5px;
        ...
        <form method="POST">
          ...
          <input type="text" name="firstname" value="<?php if(isset($record)) echo $record['firstname'];?>" required>
          <br><br>
          <p class="label-txt">Last Name</p>
          <input type="text" name="lastname" value="<?php if(isset($record)) echo $record['lastname'];?>" required>
          <br><br>
          ...
          <p class="label-txt">Status</p>
           ...
           <button type='submit' name="update">Update</button>
             <button  class="submit" type="button" name="cancel" onclick="window.location='CustomerSalesDept.php?'">Cancel</button>
        ...
        while ( $row = $result -> fetch_assoc()) {
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a  href='CustomerEditSalesDept.php?edit=<?php echo $row['id']; ?>'class="btn btn-primary a-btn-slide-text" disabled>
