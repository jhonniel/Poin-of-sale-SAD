    ...
    <ul>
      ...
      <li><a href="Login.php">Logout</a></li>
			...
			<table>
				...
				<td><input class="input" type="text" name="id" style="width: 50px;" value="<?php echo $row['id'] ?>" readonly></td>

				<td><input class="input" type="text" name="productname" value="<?php echo $row['productname'] ?>" readonly  ></td>

				<td><center><input class="input" type="text" name="quantity" style="width: 70px;" value="<?php echo $row['quantity'] ?>" readonly></center></td>
		...
		<form method="POST" action="checkoutRegular.php">
      <div class="order"><br>
      ...
      <label>Type</label><br>
        ...
        <select name="type"> 
          ...
          <option value="Online">Online</option>
			...
			<input type="submit" name="btnPlaceOrder" value="Checkout">
      </div>
		</form>
