      ...
      <div class="inputs">
        ...
        <form method="POST" action="Process.php">
          <p class="label-txt">Supplier Name</p>
            <input type="text" name='sname1' onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"class="input" required>
            <br><br>
        ...
        while ( $row = $result -> fetch_assoc()) {
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href='SupplierEdit.php?edit=<?php echo $row['id']; ?>'class="btn btn-primary a-btn-slide-text">
