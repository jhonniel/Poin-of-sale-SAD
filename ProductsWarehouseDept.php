        ...
        <form method="POST" action="Process.php" enctype="multipart/form-data">
          <div class="inputs">
            <h2 style="text-align: center;margin-top: -5px;
              ...
              <input type="text" name="description" class="input" required style="height: 50px;">
               
              <br><br>
              <button name='add9'>Add Product</button>
            ...
            if ($result -> num_rows > 0) {
             ...
             <?php }  ?> >
              ...
              <?php echo $row['quantity'];  ?></td>
                            ...
                            <td><a  href='ProductEditWarehouseDept.php?edit=<?php echo $row['id']; ?>' class="btn btn-primary a-btn-slide-text">
