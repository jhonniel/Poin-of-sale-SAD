	...
	function currentDateTime()
{
	...
	<div class="container">
	<form method="POST" action="RegularReciept.php">
		<label>Customer Name</label>
		<input type="text" name="customer_name" value="<?php echo $name; ?>">
		<br><br>
		<label>VAT</label><br>
		<input readonly type="number" value="<?php echo $VAT; ?>" name="VAT"><br>
		<br>
		<label>Subtotal</label><br>
		<input readonly type="number" name="total"value="<?php echo $total; ?>"><br>
		<br>
		<label>Delivery Fee</label><br>
		<input readonly type="number" value="<?php echo $deliveryFee; ?>"><br>
		<br>
		...
		<input type="submit" name="btnPlaceOrder" value="Place Order" required><br><br>
		<a href="RegularCart.php">Return to Cart</a>
	</form>
