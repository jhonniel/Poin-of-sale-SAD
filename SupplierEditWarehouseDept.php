...
<body>
  ...
  <div class="bodyform">
    ...
    <div class="forsearch">
      <form action="SearchSupplierWarehouseDept.php" method="POST">
    ...
    <div class="left">
      <div class="inputs">
        ...
        ">Supplier</h2><br>
        <form method="POST" action="SupplierEditWarehouseDept.php">
          <p class="label-txt">Supplier Name</p>
             <input type="text" name="name" value="<?php if(isset($record)) echo $record['name'];?>" required>
            <br><br>
          ...
          <button type='submit' name="update" >Update</button>
            <button class="submit" type="button" name="cancel"  onclick="window.location='SupplierWarehouseDept.php?'">Cancel</button>
        </div>
        </form>
        <?php 
              if (isset($_POST['update'])){
                      ...
                      header("refresh:1; url=SupplierWarehouseDept.php?"); 
        ...
        while ( $row = $result -> fetch_assoc()) {
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href='SupplierEditWarehouseDept.php?edit=<?php echo $row['id']; ?>'class="btn btn-primary a-btn-slide-text" disabled>
